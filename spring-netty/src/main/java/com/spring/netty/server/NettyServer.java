...
import com.spring.netty.utils.IpUtil;
...
public class NettyServer {
    ...
    public void sendMsg(MessageBase.Message message) {
        ...
        Channel channel = NettyServer.channels.get(ipAddr.equals(IpUtil.LOCAL_HOST) || ipAddr.equals(IpUtil.LOCAL_HOST_IPV6) ? IpUtil.LOCAL_HOST : ipAddr);
    ...
    public static void setChannels(Map<String, Channel> channels) {
        NettyServer.channels = channels;
    }
