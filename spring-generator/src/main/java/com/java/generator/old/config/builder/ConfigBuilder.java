 ...
 * the License.
 */
package com.java.generator.old.config.builder;

import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.java.generator.old.InjectionConfig;
import com.java.generator.old.config.*;
import com.java.generator.old.config.po.TableField;
import com.java.generator.old.config.po.TableFill;
import com.java.generator.old.config.po.TableInfo;
import com.java.generator.old.config.querys.H2Query;
import com.java.generator.old.config.rules.NamingStrategy;
...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getVos(), outputDir, ConstVal.VO_PATH, ConstVal.VOS);
            setPathInfo(pathInfo, template.getDos(), outputDir, ConstVal.DO_PATH, ConstVal.DOS);
            setPathInfo(pathInfo, template.getDtos(), outputDir, ConstVal.DTO_PATH, ConstVal.DTOS);
        }
    }
