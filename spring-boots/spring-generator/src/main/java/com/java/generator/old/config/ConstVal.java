 ...
 * the License.
 */
package com.java.generator.old.config;
...
public interface ConstVal {
    ...
    String TEMPLATE_VOS = "/templates/vo.java";
    String TEMPLATE_DTOS = "/templates/dto.java";
    String TEMPLATE_DOS = "/templates/do.java";
