...
//import com.java.elastic.constants.SearchConstant;
...
//    /**************************图灵商城搜索*****************************/
//    @Override
//    public ResponseResult search(RequestParam param) {
//
//        try {
//            //1、构建检索对象-封装请求相关参数信息
...
//
//            //2、进行检索操作
////            SearchResponse response = this.client.getHttpClient().execute(searchRequest, RequestOptions.DEFAULT);
////            System.out.println("response:" + response);
////            3、分析响应数据，封装成指定的格式
////            ResponseResult responseResult = startBuildResponseResult(response, param);
...
//     */
//    private SearchRequest startBuildRequestParam(RequestParam param) {
//
...
//     * 关键字查询、根据属性、分类、品牌、价格区间、是否有库存等进行过滤、分页、高亮、以及聚合统计品牌分类属性
//     */
//    private ResponseResult startBuildResponseResult(SearchResponse response, RequestParam param) {
//
...
//        List<ResponseResult.BrandVo> brandVos = new ArrayList<>();
//        //获取到品牌的聚合
//        ParsedLongTerms brandAgg = response.getAggregations().get("brand_agg");
//        for (Terms.Bucket bucket : brandAgg.getBuckets()) {
//            ResponseResult.BrandVo brandVo = new ResponseResult.BrandVo();
//
//            //获取品牌的id
...
//        //4、当前商品相关的所有类目信息
//        //获取到分类的聚合
//        List<ResponseResult.categoryVo> categoryVos = new ArrayList<>();
//
//        ParsedLongTerms categoryAgg = response.getAggregations().get("category_agg");
//
//
//        for (Terms.Bucket bucket : categoryAgg.getBuckets()) {
//            ResponseResult.categoryVo categoryVo = new ResponseResult.categoryVo();
//            //获取分类id
...
//
//        //5、获取商品相关的所有属性信息
//        List<ResponseResult.AttrVo> attrVos = new ArrayList<>();
//        //获取属性信息的聚合
//        ParsedNested attrsAgg = response.getAggregations().get("attr_agg");
//        ParsedLongTerms attrIdAgg = attrsAgg.getAggregations().get("attr_id_agg");
//        for (Terms.Bucket bucket : attrIdAgg.getBuckets()) {
//            ResponseResult.AttrVo attrVo = new ResponseResult.AttrVo();
//            //获取属性ID值
