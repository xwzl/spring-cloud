...
public class ValidatedController {
    ...
    @Operation(summary  ="single parameter check 无效果")
     ...
     */
    @PostMapping("/default")
    @Operation(summary  ="默认字段验证和返回值可见")
    ...
    @PostMapping("/game")
    @Operation(summary  ="游戏段验证和返回值可见，验证好像没有效果")
    ...
    @Operation(summary  ="篮球字段验证和返回值可见，验证好像没有效果")
