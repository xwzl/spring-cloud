...
public class RestHttpTest extends DemoApplicationTest {
    ...
    @Test
    public void getTest(){
        String prefix = "http://127.0.0.1:10000/rest/get";
        ...
        String forObject1 = restTemplate.getForObject("http://127.0.0.1:10000/rest/get/entity/{noticeId}", String.class, "111", "2222");
