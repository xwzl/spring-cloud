...
import com.java.prepare.turing.tree.AvlBinaryTree;
import org.junit.Test;

/**
 * @author xuweizhi
 * @since 2020/07/27 20:22
 */
public class AvlBinaryTreeTest {

    @Test
    public void test() {
        AvlBinaryTree<Integer> avlTree = new AvlBinaryTree<>();
        ...
        System.out.println(avlTree.findMax(avlTree.getRoot()));
        System.out.println(avlTree.findMin(avlTree.getRoot()));
